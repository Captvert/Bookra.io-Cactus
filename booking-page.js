...
function currentLanguage() {
  ...
  if (previousLanguage == 'Arabic'){
        ...
        const option1ItemContainerA = document.querySelector('.cactus-triple-container');
        option1ItemContainerA.classList.replace('cactus-triple-container' , 'cactus-triple-container-arabic');
        option1ItemContainerA.innerHTML = " <img src='ImagesFolder/chalet-stay-icon.png' class='option1-icon'>ثلاثية كاكتس";
        ...
        const option1ItemContainer = document.querySelector('.cactus-triple-container-arabic');
        option1ItemContainer.classList.replace('cactus-triple-container-arabic' , 'cactus-triple-container');
        option1ItemContainer.innerHTML = " <img src='ImagesFolder/chalet-stay-icon.png' class='option1-icon'>  Cactus Triple";
...
function dataExtraction(){
      ...
      services.forEach(service => {
        if (service.classList.contains('picked-service')){
          ...
          if (serviceName.trim() == "Cactus Triple" || serviceName.trim() == "ثلاثية كاكتس"){
